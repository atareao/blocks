...
( function( blocks, i18n, element, blockEditor ) {
    ...
    blocks.registerBlockType( 'atareao/metablock', {
        ...
        save: function(props) {
            ...
            return el(
                ...
                el(
                    ...
                    el(
                        "label",
                        {class: "atareao-metablock-label row"},
                        el(
                            "span",
                            {class: "question"},
                    ...
                    el(
                        ...
                        el(
                            "label",
                            {
                                class: "atareao-metablock-label",
                                id: "atareao-metablock-label-correo"
                            },
                            "Correo: "
                        ),
                        el(
                            "input",
                            {
                                class: "atareao-metablock-input",
                                id: "atareao-metablock-input-email",
                                type: "text",
                                placeholder: "email"
                            }
                        ),
                    ...
                    el(
                        "textarea",
                        {
                            class: "atareao-metablock-textarea row",
                            id: "atareao-metablock-textarea-answer",
                            name: "answer",
                    ...
                    el(
                        ...
                        el(
                            "button",
                            {
                                class: "atareao-metablock-button",
                                id: "atareao-metablock-button-enviar",
                            },
                            "Enviar"
                        )
                    ),
                    el(
                        ...
                        el(
                            "span",
                            {
                                class: "atareao-metablock-span",
                                id: "atareao-metablock-span-resultado",
...
function human(){
    ...
    for(const [key, value] of Object.entries(animals)){
        q.push(wp.element.createElement(
            "input",
            {
                class: "atareao-metablock-input-for-selection",
                type: "radio",
                name: "animal",
                value: key,
                id: key
        ...
        q.push(wp.element.createElement(
            "label",
            {
                class: "atareao-metablock-label-for-selection",
                for: key
            },
            value
        ));
